...
$pdf->AddPage();
	...
	$countmember=mysql_query("select * from school where users='$users'   ");
...
$pdf->Ln();
	...
	$pdf->Ln();
	$pdf->Write(6, 'Name of your Child : '.$cop.'');
	
	$pdf->Ln();
	$pdf->Write(6, 'Date of Birth : '.$copo.' ');
	
	$pdf->Ln();
	$pdf->Write(6, 'Gender : '.$copio.' ');
	
	$pdf->Ln();
$pdf->Write(6, 'Type of School/high  : '.$copoo.'');
